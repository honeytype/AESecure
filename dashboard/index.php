    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
          <h1 class="h4 mb-0 ml-2 text-gray-800">Pengamanan Data Dokumen Menggunakan Algoritma Kriptografi AES </h1>
        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            ...
            <div class="card-body">
              ...
              <br>
              <p>AESecure adalah sebuah aplikasi yang dikembangkan untuk memberikan keamanan tambahan
                pada dokumen-dokumen penting, seperti file PDF, Word, Excel, dan PPT. Aplikasi ini
                menggunakan algoritma kriptografi AES 128-bit yang terkenal kuat
                dan aman. Dengan menggunakan AESecure, pengguna dapat dengan mudah mengenkripsi dokumen
                -dokumen mereka sehingga hanya dapat diakses oleh orang yang memiliki kunci enkripsi
                yang benar.
              </p>
