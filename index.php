...
<body>
  ...
  <style>
    body {
      background-image: url('assets/assets2/img/background.JPG');
              ...
              <div class="col-lg">
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-1">Login AESecure<br>Pengamanan Data Dokumen Menggunakan Algoritma AES </h1>
                    <img src="assets/assets2/img/open-lock.png" class="mt-2 mb-4" width="100">
                  </div>
                  ...
                  <div class="copyright text-center my-auto">
                    <span>Copyright &copy;AESecure <?= date('Y'); ?> </span>
                  </div>
